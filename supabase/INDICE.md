...
| 23 | `patch-meap.sql` | MEAP completo (SANIAN): columna `juicio_clinico` en consultas y consultas_versiones + trigger de versionado actualizado para vigilarla | ⬜ pendiente |
